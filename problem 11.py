#project euler 11
#largest product of 4 nums in a 20x20 grid
...
grid = [r0, r1, r2, r3, r4, r5, r6, r7, r8, r9, r10, r11, r12, r13, r14, r15, r16, r17, r18, r19]

big = 0

#horizontal sets of 4
for y in range(0,20):
    for x in range(0,17):
...
#diagonal sets of 4 in line y=-x
for y in range(0,17):
    for x in range(0,17):
